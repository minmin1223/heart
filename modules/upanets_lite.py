...
#        self.layers = []
        ...
        self.sem_root_up = nn.Sequential(
        ...
        self.sem_emb_up = CPA(int(self.filters*31), num_classes, stride=1, up=False, same=True)

        self.ins_root_up = nn.Sequential(
                nn.Conv2d(int(self.filters*31), int(self.filters*1), kernel_size=3, padding=1, bias=False),
                nn.BatchNorm2d(int(self.filters*1)),
                nn.ReLU(),
                nn.Conv2d(int(self.filters*1), num_classes, kernel_size=3, padding=1, bias=False),
        ...
        self.ins_emb_up = CPA(int(self.filters*31), num_classes, stride=1, up=False, same=True)
...
#        out4 = np.copy(out4.cpu(), order='C')
        ...
        out0_68 = F.interpolate(out0, size=(68,68), mode='bilinear', align_corners=False)
        out0_34 = F.interpolate(out0, size=(34,34), mode='bilinear', align_corners=False)
        out0_17 = F.interpolate(out0, size=(17,17), mode='bilinear', align_corners=False)
        out0_09 = F.interpolate(out0, size=(9,9), mode='bilinear', align_corners=False)
        out0_05 = F.interpolate(out0, size=(5,5), mode='bilinear', align_corners=False)

        out1_68 = F.interpolate(out1, size=(68,68), mode='bilinear', align_corners=False)
        out1_34 = F.interpolate(out1, size=(34,34), mode='bilinear', align_corners=False)
        out1_17 = F.interpolate(out1, size=(17,17), mode='bilinear', align_corners=False)
        out1_09 = F.interpolate(out1, size=(9,9), mode='bilinear', align_corners=False)
        out1_05 = F.interpolate(out1, size=(5,5), mode='bilinear', align_corners=False)
        
        out2_68 = F.interpolate(out2, size=(68,68), mode='bilinear', align_corners=False)
        out2_34 = F.interpolate(out2, size=(34,34), mode='bilinear', align_corners=False)
        out2_17 = F.interpolate(out2, size=(17,17), mode='bilinear', align_corners=False)
        out2_09 = F.interpolate(out2, size=(9,9), mode='bilinear', align_corners=False)
        out2_05 = F.interpolate(out2, size=(5,5), mode='bilinear', align_corners=False)

        out3_68 = F.interpolate(out3, size=(68,68), mode='bilinear', align_corners=False)
        out3_34 = F.interpolate(out3, size=(34,34), mode='bilinear', align_corners=False)
        out3_17 = F.interpolate(out3, size=(17,17), mode='bilinear', align_corners=False)
        out3_09 = F.interpolate(out3, size=(9,9), mode='bilinear', align_corners=False)
        out3_05 = F.interpolate(out3, size=(5,5), mode='bilinear', align_corners=False)
        
        out4_68 = F.interpolate(out4, size=(68,68), mode='bilinear', align_corners=False)
        out4_34 = F.interpolate(out4, size=(34,34), mode='bilinear', align_corners=False)
        out4_17 = F.interpolate(out4, size=(17,17), mode='bilinear', align_corners=False)
        out4_09 = F.interpolate(out4, size=(9,9), mode='bilinear', align_corners=False)
        out4_05 = F.interpolate(out4, size=(5,5), mode='bilinear', align_corners=False)
...
#                ], 1)
        out_68 = torch.cat([out0_68, out1_68, out2_68, out3_68, out4_68], 1)
        out_34 = torch.cat([out0_34, out1_34, out2_34, out3_34, out4_34], 1)
        out_17 = torch.cat([out0_17, out1_17, out2_17, out3_17, out4_17], 1)
        out_09 = torch.cat([out0_09, out1_09, out2_09, out3_09, out4_09], 1)
        out_05 = torch.cat([out0_05, out1_05, out2_05, out3_05, out4_05], 1)
        
#        print('out combine: ',out_.shape)
        sem_out = self.sem_root_up(out_68)
        sem_out = self.sem_emb_up(out_68, sem_out)
        
        ins_out = self.ins_root_up(out_68)
        ins_out = self.ins_emb_up(out_68, ins_out)
#        print('out: ', out.shape)
#        '''extended parts'''
...
#        out4_ = F.interpolate(out0_, size=(5,5), mode='bilinear', align_corners=False)
        ...
        out_68 = self.fpn0(out_68)
        out_34 = self.fpn1(out_34)
        out_17 = self.fpn2(out_17)
        out_09 = self.fpn3(out_09)
        out_05 = self.fpn4(out_05)
...
#        return (out1, out2, out3 ,out4, out5, out6)
        return sem_out, ins_out, (out_68, out_34, out_17, out_09 ,out_05)
...
#    y = net(torch.randn(1, 3, 32, 32))
    ...
    net = UPANets(64, 21)
    y,fpn = net(torch.randn(1, 3, 544, 544))
