...
#        out4 = np.copy(out4.cpu(), order='C')
        ...
        sem_out0 = F.interpolate(out0, size=img_size, mode='bilinear', align_corners=False)
        sem_out1 = F.interpolate(out1, size=img_size, mode='bilinear', align_corners=False)
        sem_out2 = F.interpolate(out2, size=img_size, mode='bilinear', align_corners=False)
        sem_out3 = F.interpolate(out3, size=img_size, mode='bilinear', align_corners=False)
        sem_out4 = F.interpolate(out4, size=img_size, mode='bilinear', align_corners=False)

        out0_ = torch.cat([
                sem_out0, 
                sem_out1, sem_out2, sem_out3, sem_out4,# x,
#                out1_up,
