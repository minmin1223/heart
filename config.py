...
CUSTOM_CLASSES = ('IVS', 'LVPW', 'LA', 'AoR')
# CUSTOM_CLASSES = ('LA', 'AoR')
...
class res101_coco:
    def __init__(self, args):
        ...
        self.data_root = 'C:/Users/User/Hank/yolact-master/data'
        ...
        if self.mode == 'train':
            ...
            self.bs_factor = self.train_bs / 4
...
#            self.lr_steps = tuple([int(aa / self.bs_factor) for aa in (0, 60000)])
            self.scales = [int(self.img_size / 544 * aa) for aa in (32, 64, 128, 256, 512)]
            # self.scales = [int(self.img_size / 544 * 96)]
...
class res50_custom(res101_coco):
    def __init__(self, args):
        ...
        if self.mode == 'train':
            self.train_imgs = 'E:/Bo/datas/raw_image/'
            self.train_ann = 'E:/Bo/datas/Allmode_train.json'
            self.warmup_until = 10  # just an example
            self.lr_steps = tuple([int(aa / self.bs_factor) for aa in (0, 20000, 60000, 100000)])
            self.scales = [int(self.img_size / 544 * aa) for aa in (32, 64, 128, 256, 512)]

        if self.mode in ('train', 'val'):
            self.val_imgs = 'E:/Bo/datas/raw_image/'  # decide by yourself
            self.val_ann = 'E:/Bo/datas/Allmode_test.json'
# class res50_custom(res101_coco):
#     def __init__(self, args):
#         super().__init__(args)
#         self.class_names = CUSTOM_CLASSES
...
#         if self.mode == 'train':
#             self.train_imgs = 'D:/Bo/datas/IVS&LVPW/raw/'
#             self.train_ann = 'D:/Bo/datas/IVS&LVPW/train.json'
#             self.warmup_until = 10  # just an example
#             self.lr_steps =(0, 16000, 22000)  # just an example

#         if self.mode in ('train', 'val'):
#             self.val_imgs = 'D:/Bo/datas/IVS&LVPW/raw/'  # decide by yourself
#             self.val_ann = 'D:/Bo/datas/IVS&LVPW/test.json'
